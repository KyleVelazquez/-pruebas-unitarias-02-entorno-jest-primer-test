...
const tareas = [
  { id: 1, titulo: "Estudiar pruebas", completada: false,  descripcion: "Estudiar pruebas unitarias usando Jest" },  // Esta tarea está pendiente
  { id: 2, titulo: "Hacer ejercicio", completada: true, descripcion: "Correr 30 minutos a 10km/h" },    // Esta tarea ya está terminada
];
